...
const Categories = () => {
  ...
  const { listCategories, allCategories } = useSelector(
                ...
                <table className="table table-vcenter datatable table-hover table-bordered card-table fs-5">
                  <thead>
                    <tr>
                      ...
                      <th className="bg-dark text-white">Has Brand/s?</th>
                    ...
                    {isLoading ? (
                      ...
                      <>
                        {listCategories.map((i, index) => {
                          ...
                          const hasBrand = i?.has_brand ? (
                            <span className="badge bg-primary-lt p-1">Yes</span>
                          ) : (
                            <span className="badge bg-danger-lt p-1">No</span>
                          );
